        ...
        options: {
          ...
          middleware: function (connect) {
            return [
              ...
              connect().use(
                '/pub/styles',
                connect.static('./pub/styles')
              ),
              connect.static(appConfig.pub)
            ];
          }
        }
      },
